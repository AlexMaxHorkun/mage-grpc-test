...
/**
 * Autogenerated description for Cleared class
 *
 ...
 */
final class ClearedMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ClearedInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(Cleared $dto, string $key, $value): void
    {
        switch ($key) {
        }
    }
