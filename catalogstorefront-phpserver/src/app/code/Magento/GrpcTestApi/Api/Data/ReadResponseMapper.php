 ...
 */
final class ReadResponseMapper
{
    /**
     * @var string
     */
    private static $dtoClassName = ReadResponseInterface::class;
    ...
    * @param mixed $value
    */
    private function setByKey(ReadResponse $dto, string $key, $value): void
    {
        switch ($key) {
            case "items":
                $convertedArray = [];
                foreach ($value as $element) {
                    $convertedArray[] = $this->objectManager
                        ->create(\Magento\GrpcTestApi\Api\Data\ProductMapper::class)
                        ->setData($element)
                        ->build();
                }
